...
@model({settings: {idInjection: false, mssql: {schema: 'dbo', table: 'attribute'}}})
export class Attribute extends Entity {
  ...
  @property({
    ...
    length: 200,
    generated: 0,
    mssql: {columnName: 'attribute_name', dataType: 'varchar', dataLength: 200, dataPrecision: null, dataScale: null, nullable: 'YES', generated: 0},
  })
